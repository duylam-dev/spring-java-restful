...
import vn.duylamhust.jobhunter.domain.request.ReqLoginDTO;
import vn.duylamhust.jobhunter.domain.response.ResLoginDTO;
...
public class SecurityUtil {
    ...
    @Value("${duylamhust.jwt.access-token-validity-in-seconds}")
    private long accessTokenExpiration;
    @Value("${duylamhust.jwt.refresh-token-validity-in-seconds}")
    ...
    public ResCreateUserDTO registerUser(User user) throws IdInvalidException {
        return userService.handleCreate(user);
    }
    ...
    private String generateToken(String email, ResLoginDTO.UserGetAccount user, boolean refresh) {
        ...
        var userToken = new ResLoginDTO.UserInsideToken(user.getUser().getId(), user.getUser().getName(), email);
